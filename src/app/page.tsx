         ...
         <MaxWidthWrapper>
            <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
               <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Tu Marketplace para
                  <span className="text-blue-600"> recursos digitales</span> de
                  alta calidad.
               </h1>
               <p className="mt-6 text-lg max-w-prose text-muted-foreground">
                  Bienvenido a HippoMarket. Cada recurso en nuestra plataforma
                  es verificado por nuestro equipo para asegurar un alto
                  estándar de calidad.
               </p>
